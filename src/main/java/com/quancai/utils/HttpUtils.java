...
public class HttpUtils {
    ...
    public static List<String> getImageSrc(String htmlCode) {
        ...
        String picPattern = "<img//b[^>]*//bsrc//b//s*=//s*('|/\")?([^\\'/\"/n/r/f>]+(//.jpg|//.bmp|//.eps|//.gif|//.mif|//.miff|//.png|//.tif|//.tiff|//.svg|//.wmf|//.jpe|//.jpeg|//.dib|//.ico|//.tga|//.cut|//.pic)//b)[^>]*>";
        Pattern p = Pattern.compile(picPattern, Pattern.CASE_INSENSITIVE);
